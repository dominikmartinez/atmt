...
def base_architecture(args):
    ...
    args.encoder_dropout_in = getattr(args, 'encoder_dropout_in', 0.10)
    args.encoder_dropout_out = getattr(args, 'encoder_dropout_out', 0.10)
    ...
    args.decoder_dropout_in = getattr(args, 'decoder_dropout_in', 0.10)
    args.decoder_dropout_out = getattr(args, 'decoder_dropout_out', 0.10)
